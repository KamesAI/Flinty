  ...
  if (collapsed) {
    const link = (
      <Link
        ...
        className={cn(
          "group relative flex items-center justify-center gap-3 rounded-lg px-2 py-2 text-sm font-medium transition-all",
          active
            ? "bg-primary/10 text-primary"
            : "text-sidebar-foreground hover:bg-sidebar-accent hover:text-foreground"
        )}
    ...
    <div>
      <div className="flex items-center">
        <Link
          href={item.href}
          className={cn(
            "group relative flex flex-1 items-center gap-3 rounded-l-lg px-3 py-2 text-sm font-medium transition-all",
            active
              ? "bg-primary/10 text-primary"
              : "text-sidebar-foreground hover:bg-sidebar-accent hover:text-foreground"
          )}
        ...
        <button
          ...
          onClick={() => setOpen((v) => !v)}
          aria-expanded={open}
          aria-label="Toggle sous-menu"
          className={cn(
            "flex h-9 w-9 shrink-0 items-center justify-center rounded-r-lg transition-colors",
            active
