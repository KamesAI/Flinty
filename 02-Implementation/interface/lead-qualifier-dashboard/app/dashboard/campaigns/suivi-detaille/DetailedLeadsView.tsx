              ...
              <div className="flex flex-wrap items-center gap-2 rounded-[12px] border border-slate-200 bg-white/70 p-2">
                <div className="relative min-w-[220px] flex-1">
                  ...
                  <input
                    ...
                    type="search"
                    placeholder="Recherche nom, prénom, email, site…"
                    value={filters.query}
                ...
                <table className="w-full min-w-[960px] text-[13px]" data-testid="qualified-table">
                  <thead className="sticky top-0 bg-slate-50/80 backdrop-blur">
                    <tr className="border-b border-slate-200 text-left">
                      <ThSortable label="Prénom"   sortKey="prénom"        sort={sort} onClick={toggleSort} />
                      <ThSortable label="Nom"      sortKey="nom"           sort={sort} onClick={toggleSort} />
                      ...
                      <ThSortable label="Statut"   sortKey="statut_email"  sort={sort} onClick={toggleSort} />
                  ...
                  <tbody>
                    {visibleQualified.map((lead) => {
                      ...
                      return (
                        ...
                        >
                          <td className="px-3 py-2 font-medium text-slate-900">{lead.prénom || "—"}</td>
                  ...
                  <tbody>
                    {rejectedLeads.map((lead) => {
                      const siteHref = lead.site
                        ...
                        : null;
                      return (
                        <tr key={lead.lead_id} className="border-b border-slate-100 hover:bg-slate-50">
                          <td className="px-3 py-2 text-slate-900">{lead.nom || "—"}</td>
