...
export function CampaignKanban({
  ...
  const [activeColumns, setActiveColumns] = useState<CampaignBoardColumn[]>(
    initialModel.activeColumns,
  );
  const [archivedColumns, setArchivedColumns] = useState<CampaignBoardColumn[]>(
    initialModel.archivedColumns,
  );
  ...
  const setCurrentColumns = tab === "active" ? setActiveColumns : setArchivedColumns;
  ...
  function handleDragEnd({ active, over }: DragEndEvent) {
    ...
    setCurrentColumns((prev) =>
      moveCampaignCard(prev, active.id as string, targetColumnId),
    );
  }
