...
La priorite est de connecter **Calendly** et d'afficher les meetings dans l'interface Kames sans creer, modifier ni replanifier d'evenements.
...
L'objectif n'est pas de repliquer Calendly. Il faut juste donner a Kames une **vue commerciale exploitable** des rendez-vous lies a la prospection, avec contexte campagne + lead.
