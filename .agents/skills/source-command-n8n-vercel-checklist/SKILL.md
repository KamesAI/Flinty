---
name: "source-command-n8n-vercel-checklist"
description: "Checklist callbacks WF1/WF2 et variables Vercel avant staging ou prod"
---

# source-command-n8n-vercel-checklist

Use this skill when the user asks to run the migrated source command `n8n-vercel-checklist`.
