export function getCampaignRowThemeTokens() {
  return {
    ...
    stageFills: {
      ...
      contacted: "color-mix(in srgb, #059669 22%, transparent)",
      replies: "color-mix(in srgb, #059669 38%, transparent)",
    },
    ...
    generatingBackground: "color-mix(in srgb, #059669 10%, var(--dashboard-card-bg))",
    generatingBorder: "color-mix(in srgb, #059669 18%, var(--dashboard-border))",
    generatingText: "color-mix(in srgb, #059669 72%, var(--dashboard-text-primary))",
    generatingDot: "#059669",
    activeDot: "#10B981",
    completedDot: "#7DD3FC",
